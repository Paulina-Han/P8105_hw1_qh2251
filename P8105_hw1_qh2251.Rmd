...
```
The data set includes 344 observations and 8 variables.The detail is in the `description`. There are 344 `row`s and 8 `col`s in the data set.The `mean` flipper length is 200.9152.
