...
For species is a factor variable which has 152 Adelie penguins, 68
Chinstrap penguins and 124 Gentoo penguins.

For island is a factor variable which has 168 penguins from Biscoe,124
penguins from Dream and 52 penguins from Torgersen.

For bill\_length\_mm is a numeric variable with 2 missing values. The
mean is 43.92, the min is 32.1, the max is 59.6.

For bill\_depth\_mm is a numeric variable with 2 missing values. The
mean is 17.15, the min is 13.10, the max is 21.5.

For flipper\_length\_mm is a numeric variable with 2 missing values. The
mean is 200.9 , the min is 172, the max is 231.

For body\_mass\_g is a numeric variable with 2 missing values. The mean
is 4202 , the min is 2700, the max is 6300.

For sex is a factor variable with 11 missing values. There are 165
female penguins and 168 male penguins.

For year is a numeric variable . The mean is 2008 , the min is 2007, the
max is 2009.
